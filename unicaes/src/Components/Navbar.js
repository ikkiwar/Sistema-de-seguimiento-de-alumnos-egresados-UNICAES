        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav mr-auto">
            ...
            <li className="nav-item">
              <a className="nav-link" href="#">Perfiles</a>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item dropdown">  
              ...
              <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                <a className="dropdown-item" href="#">Aptitudes</a>
                <a className="dropdown-item" href="#">Cargos</a>
                <a className="dropdown-item" href="#">Facultades</a>
                <a className="dropdown-item" href="#">Instituciones</a>
                <a className="dropdown-item" href="#">Registrar egresado</a>
